          ...
          <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-4">
            {process.map((item, index) => (
              ...
              >
                ...
                {/* Card */}
                <div className="mt-5 h-full rounded-3xl border border-white/10 bg-white/[0.025] p-7 backdrop-blur-sm transition-all duration-500 group-hover:-translate-y-1 group-hover:border-blue-400/20 group-hover:bg-white/[0.045] group-hover:shadow-2xl group-hover:shadow-blue-950/20">
                  {/* Large step number */}
